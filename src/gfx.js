...
class Gfx
{
	...
	createScene()
	{
		...
		this.loadModelFromString(OBJ_OBSTACLE_FULL, "0  20  50  0  50  30 0 30 70 0 30 80 60 20 20 60 20 30 0 30 30 0 70 70 0 70 80 60 80 20 60 80  0 1 2 3 5 0 3 8 1 6 7 2 3 2 7 8  0 0 4 0 0 0 0 0 0 0", scene);
		...
		this.loadModelFromString(OBJ_OBSTACLE_LOWER, "1  20  50  0  50  30 0 30 70 0 30 80 10 20 20 10 20 30 0 30 30 0 70 70 0 70 60 40 80 40 40 80  0 1 2 3 5 0 3 8 1 6 7 2 3 2 7 8  0 0 4 0 0 0 0 0 0 0", scene);
		this.loadModelFromString(OBJ_EDGE, "1  50  50  0  50  0 0 0 33 0 0 33 70 0 0 50 0 0 90 50 33 90 50 33 0 50 0 0 50  0 1 2 3 7 0 3 4 1 6 5 2 3 2 5 4  0 0 4 0 0 0 0 0 0 0", scene);
